...
def show_wc(text,cmap):
    ...
    wordcloud = WordCloud( max_font_size=200,width=2000, height=1000,max_words=150,collocations=False,stopwords=stop_words,background_color='#D8C3A5', colormap=cmap, mask=mask).generate(text)
